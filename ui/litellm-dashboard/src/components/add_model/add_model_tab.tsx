            ...
            <Row>
              ...
              <Col span={10}>
                <Text className="mb-5 mt-1">
                  <strong>Optional</strong> - iAgamiLLM endpoint to use when health checking this model <Link href="https://docs.litellm.ai/docs/proxy/health#health" target="_blank">Learn more</Link>
                </Text>
              </Col>
            </Row>

  ...
  return (
    <>
      <Form.Item
        ...
        className="mb-4"
        tooltip="Tell iAgamiLLM where to inject cache control checkpoints. You can specify either by role (to apply to all messages of that role) or by specific message index."
      >
      ...
      {showCacheControl && (
        <div className="ml-6 pl-4 border-l-2 border-gray-200">
          <Text className="text-sm text-gray-500 block mb-4">
            ...
            iAgamiLLM can automatically add them for you as a cost saving feature.
          </Text>
                ...
                {fields.map((field, index) => (
                  <div key={field.key} className="flex items-center mb-4 gap-4">
                    ...
                    <Form.Item
                      ...
                      className="mb-0"
                      style={{ width: '180px' }}
                      tooltip="iAgamiLLM will mark all messages of this role as cacheable"
                    >
                      <Select
                    ...
                    <Form.Item
                      ...
                      className="mb-0"
                      style={{ width: '180px' }}
                      tooltip="(Optional) If set iAgamiLLM will mark the message at this index as cacheable"
                    >
                      <NumericalInput
                        type="number"

    ...
    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-start">
      ...
      <div>
        ...
        <p className="text-sm text-blue-700 mt-1">
          To view request and response details, enable prompt storage in your iAgamiLLM configuration by adding the following to your <code className="bg-blue-100 px-1 py-0.5 rounded">proxy_config.yaml</code> file:
        </p>

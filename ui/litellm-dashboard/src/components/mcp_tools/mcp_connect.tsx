    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-emerald-50 to-green-50 p-6 rounded-lg border border-emerald-100">
        <div className="flex items-center gap-3 mb-3">
          ...
          <Title level={4} className="mb-0 text-emerald-900">iAgamiLLM Proxy API Integration</Title>
        </div>
        <Text className="text-emerald-700">
          Connect to iAgamiLLM Proxy Responses API for seamless tool integration with multiple model providers
        </Text>
      </div>
      ...
      <Space direction="vertical" size="large" className="w-full">
        <FeatureCard
          ...
          title="API Key Setup"
          description="Configure your iAgamiLLM Proxy API key for authentication"
        >
          <Space direction="vertical" size="middle" className="w-full">
            <div>
              <Text>Get your API key from your iAgamiLLM Proxy dashboard or contact your administrator</Text>
            </div>
            <CodeBlock
        ...
        <FeatureCard
          ...
          description="Connection details for your iAgamiLLM MCP server"
        >
          <CodeBlock
            title="Server URL"
        ...
        <FeatureCard
          ...
          description="Complete cURL example for using the iAgamiLLM Proxy Responses API"
        >
          <CodeBlock
    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-lg border border-blue-100">
        ...
        <Text className="text-blue-700">
          Connect OpenAI Responses API to your iAgamiLLM MCP server for seamless tool integration
        </Text>
      </div>
    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-6 rounded-lg border border-purple-100">
        ...
        <Text className="text-purple-700">
          Use tools directly from Cursor IDE with iAgamiLLM MCP. Enable your AI assistant to perform real-world tasks without leaving your coding environment.
        </Text>
      </div>
    ...
    <Space direction="vertical" size="large" className="w-full">
      <div className="bg-gradient-to-r from-green-50 to-teal-50 p-6 rounded-lg border border-green-100">
        ...
        <Text className="text-green-700">
          Connect to iAgamiLLM MCP using HTTP transport. Compatible with any MCP client that supports HTTP streaming.
        </Text>
      </div>
      ...
      <Space direction="vertical" size="large" className="w-full">
        <div>
          ...
          <TremorText className="text-lg text-gray-600">
            Use tools directly from any MCP client with iAgamiLLM MCP. Enable your AI assistant to perform real-world tasks through a simple, secure connection.
          </TremorText>
        </div>

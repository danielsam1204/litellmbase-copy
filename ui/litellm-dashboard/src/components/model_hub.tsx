...
client = openai.OpenAI(
    ...
    base_url="http://0.0.0.0:4000" # iAgamiLLM Proxy is OpenAI compatible, Read More: https://docs.litellm.ai/docs/proxy/user_keys
)
...
llm = AzureOpenAI(
    engine="${selectedModel.model_group}",               # model_name on iAgamiLLM proxy
    temperature=0.0,
    azure_endpoint="http://0.0.0.0:4000", # iAgamiLLM proxy endpoint
